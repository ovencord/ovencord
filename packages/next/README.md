<div align="center">
	...
	<p>
		...
		<a href="https://github.com/ovencord/ovencord/commits/main/packages/next"><img alt="Last commit." src="https://img.shields.io/github/last-commit/ovencord/ovencord?logo=github&logoColor=ffffff&path=packages%2Fnext" /></a>
...
```sh
npm install @ovencord/next
yarn add @ovencord/next
pnpm add @ovencord/next
bun add @ovencord/next
```
...
[source]: https://github.com/ovencord/ovencord/tree/main/packages/next
[npm]: https://www.npmjs.com/package/@ovencord/next
