...
<div align="left">
	<p>
		...
		<img src="https://saizu.dev/badge/@ovencord/collection?type=install" alt="install size">
...
`@ovencord/collection` is a powerful utility data structure used in `@ovencord/discord.js` that uses no dependencies.
