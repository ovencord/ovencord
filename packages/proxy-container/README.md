...
`@ovencord/proxy-container` - Lightweight HTTP proxy for Discord's API, brought to you as a container 📦
...
[source]: https://github.com/ovencord/ovencord/tree/main/packages/proxy-container
