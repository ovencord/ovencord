...
```ts
import { ApiModel, ApiPackage } from '@ovencord/api-extractor-model';
...
- [CHANGELOG.md](https://github.com/ovencord/ovencord/blob/main/packages/api-extractor-model/CHANGELOG.md) - Find
