...
declare const guildChannelManager: GuildChannelManager;
{
	...
	expectType<Promise<Collection<Snowflake, NonThreadGuildBasedChannel | null>>>(
		guildChannelManager.fetch(undefined, { cache: true }) as unknown as Promise<
			Collection<Snowflake, NonThreadGuildBasedChannel | null>
		>,
	);
...
expectType<Promise<Collection<Snowflake, Role>>>(
	roleManager.fetch(undefined, { cache: true }) as unknown as Promise<Collection<Snowflake, Role>>,
);
...
expectType<Promise<Collection<Snowflake, GuildEmoji>>>(
	guildEmojiManager.fetch(undefined, { cache: true }) as unknown as Promise<Collection<Snowflake, GuildEmoji>>,
);
...
expectType<Promise<Collection<Snowflake, ApplicationEmoji>>>(
	applicationEmojiManager.fetch(undefined, { cache: true }) as unknown as Promise<
		Collection<Snowflake, ApplicationEmoji>
	>,
);
