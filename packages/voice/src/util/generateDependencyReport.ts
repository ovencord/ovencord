...
/**
 * Generates a report of the dependencies used by the \@ovencord/voice module.
...
export function generateDependencyReport() {
	...
	report.push(`- @noble/ciphers support for aes-256-gcm: yes`);
